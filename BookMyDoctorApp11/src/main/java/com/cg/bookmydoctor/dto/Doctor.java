...
public class Doctor {
	...
	public Doctor(int doctorId, String doctorName, String speciality, String location, String hospitalName,long mobileNo, String email, String password, double chargesPerVisit) {
		super();
